...
public class RoutineDTO {
    ...
    public static Routine convertToModel(RoutineDTO routinePostRequest, int userId) {
        return new Routine(routinePostRequest.getID(), routinePostRequest.getName(), ActionDTO.convertToModel(routinePostRequest.getActions(), userId), routinePostRequest.getTrigger().getValue(), routinePostRequest.isState());
    }
